...
parser.add_argument('--n_GPUs', type=int, default=1,
                    help='number of GPUs')
parser.add_argument('--cuda_name', type=str, default='1') #cuda
...
parser.add_argument('--num_features', type=int, default=64)#64
...
parser.add_argument('--data_path', type=str, default='',
                    help='file path to save model')
parser.add_argument('--load', type=str, default='./models/SFMGAN_x8.pth',
